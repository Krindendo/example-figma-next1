...
export default function Kontakt() {
  return (
    <section className="container inline-flex justify-center items-center gap-16 h-full flex-1">
      <iframe
        ...
        className="border-none w-4/6"
        height={450}
        allowFullScreen={false}
        loading="lazy"
        referrerPolicy="no-referrer-when-downgrade"
      ></iframe>
      <div className="flex flex-col justify-between gap-12 w-2/6 h-full">
